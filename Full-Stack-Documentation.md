...
9 character-voice MP3 greeting clips are hosted on Twilio Assets (service `beabeacallme-1558`, visibility: Protected) at `https://beabeacallme-1558.twil.io/`. The clips were generated using [fish.audio](https://fish.audio/app) — an AI voice synthesis tool — using voices modeled after characters Bea recognizes (Bluey, Goofy, Leela, Minnie, Ms. Rachel, Prof. Farnsworth, Zoidberg, and two K-pop voices).
